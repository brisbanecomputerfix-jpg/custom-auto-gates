...
export const REGIONAL_DATA = {
  brisbane: {
    ...
    suburbs: [
      ...
      { name: 'Camp Hill', postcode: '4152', area: 'South / East', desc: 'Dual swing automatic gates with concealed underground automated gate motors.' },
      { name: 'Carindale', postcode: '4152', area: 'East', desc: 'Full front boundary Colorbond slat fencing with pedestrian access gate.' },
      { name: 'Indooroopilly', postcode: '4068', area: 'West', desc: 'Double swing aluminium gates with high-speed Commercial-Grade automation.' },
    ...
    popularGateStyles: [
      { name: 'Monument Slat Sliding Gate', motor: 'Premium Smart High-Speed Motor', tag: 'Most Popular in Brisbane Inner Suburbs' },
      { name: 'Acreage Solar Double Swing Gate', motor: 'Solar Powered Swing Motor', tag: 'Top Choice in Pullenvale & Brookfield' },
      { name: 'DecoWood Timber-Look Gate', motor: 'Heavy-Duty Linear Swing Motor', tag: 'Popular in Ascot & Paddington Heritage' },
      { name: 'Bi-Fold Space Saving Gate', motor: 'Articulated Swing Gate Motor', tag: 'Best for Short Driveways in New Farm' }
    ]
  },
  ipswich: {
    id: 'ipswich',
    ...
    suburbs: [
      ...
      { name: 'Karalee', postcode: '4306', area: 'Riverside Acreage', desc: 'Acreage dual swing solar gates with high-torque automated arms.' },
    ...
    popularGateStyles: [
      { name: 'Yamanto Custom Laser Cut Slide Gate', motor: 'Premium Smart High-Speed Motor', tag: 'Built 100% In-House in Yamanto' },
      { name: 'Brookwater Architectural Slat System', motor: 'Premium High-Speed Sliding Motor', tag: 'Top Choice in Springfield & Brookwater' },
      { name: 'Karalee Solar Double Swing Gate', motor: 'Solar Double Swing Motor', tag: 'Best for Ipswich Acreage Properties' },
      { name: 'Ripley New Home Complete Pack', motor: 'Standard Automatic Sliding Motor', tag: 'Complete Fence & Gate Combo' }
    ]
  },
  logan: {
    id: 'logan',
    ...
    popularGateStyles: [
      { name: 'Commercial Cantilever Security Gate', motor: 'Commercial Heavy-Duty Motor', tag: 'Top Choice in Berrinba Logistics Park' },
      { name: 'Greenbank Solar Acreage Swing System', motor: 'Heavy-Duty Double Swing Motor', tag: 'Most Popular in Logan Acreage' },
      { name: 'Cleveland Marine-Grade Slide Gate', motor: 'Premium Smart Motor Marine Finish', tag: 'Best for Redlands Salt Air Coast' },
      { name: 'Springwood Slat Privacy Sliding Gate', motor: 'Standard Automatic Sliding Motor', tag: 'Popular in Suburban Logan' }
    ]
  },
  goldcoast: {
    id: 'goldcoast',
    ...
    subtitle: 'Engineered specifically for coastal Queensland conditions. 100% corrosion-resistant 6060-T6 aluminium alloy, marine-grade powdercoating, and high-speed smart gate automation for Gold Coast homes, strata, and canal estates.',
    ...
    suburbs: [
      ...
      { name: 'Helensvale', postcode: '4212', area: 'North GC', desc: 'Dual swing automatic gates with high-speed smart gate automation.' },
    ...
    popularGateStyles: [
      { name: 'Hope Island Canal Slat Gate', motor: 'Premium High-Speed Sliding Motor', tag: 'Prestige Coastal Living' },
      { name: 'Southport Commercial Strata Gate', motor: 'Commercial Inverter Motor', tag: 'Heavy-Duty Multi-Unit Complexes' },
      { name: 'Tamborine Hinterland Solar Gate', motor: 'Solar Powered Swing Motor', tag: 'High-Torque Mountain Acreage' },
      { name: 'Coomera Modern Slat Privacy Combo', motor: 'Premium Smart Motor', tag: 'Modern Residential Estates' }
    ]
  }
};
