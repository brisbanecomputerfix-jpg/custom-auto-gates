...
export const DETAILED_REVIEWS = [
  {
    ...
    motor: 'Premium Smart Hi-Speed Motor with Smartphone Module',
  ...
  },
  {
    ...
    motor: 'Solar Double Swing Motor with Dual 40W Solar Panels',
    ...
    solution: 'Engineered an off-grid solar system with dual deep-cycle AGM batteries and high-torque Commercial-Grade arms.',
  ...
  },
  {
    ...
    motor: 'Commercial Inverter Drive + Magnetic Barrier',
  ...
  },
  {
    ...
    motor: 'Articulated Swing Gate Motor with Keypad',
  ...
  },
  {
    ...
    motor: 'Commercial High-Speed Barrier System',
  ...
  },
  {
    ...
    motor: 'Premium Smart Motor with Video Intercom Integration',
    ...
    text: 'Living in New Farm with tight driveway access, we needed an electric gate that opened quickly so cars didn’t bank up on the street. The high-speed automated motor opens the full 4.5m gate in under 7 seconds! The installation team left the site spotless.',
    engineerNote: 'Installed safety infrared beams ensuring automatic reverse if children or pets approach.',
    helpfulCount: 27
  },
  {
    id: 'rev-7',
    ...
    motor: 'Commercial Inverter Motors',
    ...
    solution: 'Replaced substandard hardware with commercial Smart Gate Automation inverter motors and heavy-duty steel rollers.',
  ...
  },
  {
    ...
    motor: 'Premium Smart Motor with Keypad & Video Doorbell',
  ...
  },
  {
    ...
    motor: 'Standard Automatic Sliding Gate Motor',
  ...
  },
  {
    ...
    motor: 'Premium Smart Motor with In-Ground Track System',
  ...
  },
  {
    ...
    motor: 'High-Speed Solar Double Swing Motor Setup',
  ...
  },
  {
    ...
    motor: 'Premium Smart Motor with Stainless Steel Marine Hardware',
...
export default function Testimonials({ onOpenQuote, onOpenContact, onNavigateHome }) {
  ...
  const rollingReviews = useMemo(() => [
    { name: 'Mark J.', suburb: 'Brookwater', text: 'Millimeter-perfect fit for our sloping driveway. automated gate motor is whisper quiet!' },
    ...
    { name: 'Belinda K.', suburb: 'New Farm', text: 'Opens in under 7 seconds! Incredibly fast automated gate motor and spotless install.' },
