...
export const DETAILED_REVIEWS = [
  {
    ...
    motor: 'Italian Nice Robus 500 Hi-Speed with WiFi Module',
    ...
    text: 'From our first on-site laser measure to the final installation, Custom Auto Gates were exceptional. Having the gate custom built in their Yamanto workshop meant the fit was 100% millimeter-perfect for our sloping driveway. The Italian Nice motor is whisper-quiet and opening it from our smartphones when pulling into the street is an absolute game-changer. Couldn’t be happier!',
  ...
  },
  {
    ...
    motor: 'Nice Run 2500 Industrial 3-Phase Inverter Drive + Magnetic Barrier',
  ...
  },
  {
    ...
    motor: 'Nice Hyke Articulated Arm Automation with Keypad',
  ...
  },
  {
    ...
    motor: 'Italian Nice Robus 600 with Video Intercom Integration',
    ...
    text: 'Living in New Farm with tight driveway access, we needed an electric gate that opened quickly so cars didn’t bank up on the street. The Nice Hi-Speed motor opens the full 4.5m gate in under 7 seconds! The installation team left the site spotless.',
    engineerNote: 'Installed Nice BlueBUS safety infrared beams ensuring automatic reverse if children or pets approach.',
    helpfulCount: 27
  },
  {
    id: 'rev-7',
    ...
    motor: 'Nice Tub 3500 Commercial Inverter Motors',
    ...
    solution: 'Replaced substandard hardware with commercial Italian Nice Tub motors and heavy-duty steel rollers.',
  ...
  },
  {
    ...
    motor: 'Nice Robus 500 with Keypad & Video Doorbell',
  ...
  },
  {
    ...
    motor: 'Nice Robus 500 with In-Ground Track System',
  ...
  },
  {
    ...
    motor: 'Nice Toona 5024 High-Speed Double Swing Solar Setup',
  ...
  },
  {
    ...
    motor: 'Nice Robus 500 with Stainless Steel Marine Hardware',
...
export default function Testimonials({ onOpenQuote, onOpenContact, onNavigateHome }) {
  ...
  const rollingReviews = useMemo(() => [
    { name: 'Mark J.', suburb: 'Brookwater', text: 'Millimeter-perfect fit for our sloping driveway. Nice motor is whisper quiet!' },
    ...
    { name: 'Belinda K.', suburb: 'New Farm', text: 'Opens in under 7 seconds! Incredibly fast Nice motor and spotless install.' },
